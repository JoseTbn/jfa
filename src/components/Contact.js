        ...
        ">
            <div class="flex justify-center mb-8 space-x-6 md:order-last md:mb-0">
              ...
              <div class="mt-8 md:mt-0 md:order-1">
                <span class="mt-2 text-sm font-light text-gray-500"> Copyright © 2021 - 2022 <a href="https://linktr.ee/JojoFullStackAdventures" class="mx-2 text-wickedblue hover:text-gray-500" rel="noopener noreferrer">@JojoFullStackAdventures</a>. Since 2020 </span>
              </div>
            </div>
