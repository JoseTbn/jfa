...
<div className="py-24 px-80 xl:py-12 xl:px-16 md:py-12 md:px-16 2xl:max-w-full 2xl:py-12 2xl:px-28">
          ...
          <motion.div className='  flex flex-row flex-wrap items-baseline justify-between gap-24 '>
            ...
            <svg className='h-auto mb-5 relative w-auto mx-auto' width="40" height="40" viewBox="0 0 50 50" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <motion.p variants={textreveal} class="font-bebasB lg:font-normal leading-8 m-0 p-0 lg:text-lg xl:text-xl xl:leading-8">Observability and Analysis</motion.p>
                    <motion.p variants={textreveal}>The starting point of every project is research. The ideate phase helps clients re-imagine their
            ...
            <svg className='h-auto mb-5 relative w-auto mx-auto' width="40" height="40" viewBox="0 0 50 50" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <motion.p variants={textreveal} class="font-bebasB lg:font-normal leading-8 m-0 p-0 lg:text-lg xl:text-xl xl:leading-8">App Definition and Development</motion.p>
                    <motion.p variants={textreveal}>The starting point of every project is research. The ideate phase helps clients re-imagine their
                      projects to better respond to their users’ needs. Think outside the box to create a solid and
                      lasting bond based on collaboration</motion.p>
            </div>
            ...
            <svg className='h-auto mb-5 relative w-auto mx-auto' width="40" height="40" viewBox="0 0 50 50" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <motion.p variants={textreveal} class="font-bebasB lg:font-normal leading-8 m-0 p-0 lg:text-lg xl:text-xl xl:leading-8">Provisioning</motion.p>
                    <motion.p variants={textreveal}>The starting point of every project is research. The ideate phase helps clients re-imagine their
                      projects to better respond to their users’ needs. Think outside the box to create a solid and
                      lasting bond based on collaboration</motion.p>
            </div>
            ...
            <svg className='h-auto mb-5 relative w-auto mx-auto' width="40" height="40" viewBox="0 0 50 50" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <motion.p variants={textreveal} class="font-bebasB leading-8 m-0 p-0 xl:text-xl xl:leading-8">Orchestration & Management</motion.p>
                    <motion.p variants={textreveal}>The starting point of every project is research. The ideate phase helps clients re-imagine their
                      projects to better respond to their users’ needs. Think outside the box to create a solid and
                      lasting bond based on collaboration</motion.p>
            </div>
            ...
            <svg className='h-auto mb-5 relative w-auto mx-auto' width="40" height="40" viewBox="0 0 50 50" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <motion.p variants={textreveal} class="font-bebasB lg:font-normal leading-8 m-0 p-0 lg:text-lg xl:text-xl xl:leading-8">Runtime</motion.p>
                    <motion.p variants={textreveal}>The starting point of every project is research. The ideate phase helps clients re-imagine their
                      projects to better respond to their users’ needs. Think outside the box to create a solid and
                      lasting bond based on collaboration</motion.p>
            </div>
            ...
            <svg className='h-auto mb-5 relative w-auto mx-auto' width="40" height="40" viewBox="0 0 50 50" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <motion.p variants={textreveal} class="font-bebasB lg:font-normal leading-8 m-0 p-0 lg:text-lg xl:text-xl xl:leading-8">Platform</motion.p>
                    <motion.p variants={textreveal}>The starting point of every project is research. The ideate phase helps clients re-imagine their
                      projects to better respond to their users’ needs. Think outside the box to create a solid and
                      lasting bond based on collaboration</motion.p>
            </div>
